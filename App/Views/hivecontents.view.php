    ...
    <div id="<?php echo $content->contentid; ?>" style="<?php echo $content->getStyleString(); ?>" class="hiveContentBox <?php if ($content->isPseudoRoot): ?>root<?php else: ?>child<?php endif; ?>">
        <svg width="270" height="125" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink">
            <g class="hiveGraphicGroup">
                ...
                <a xlink:href="#">
                    <text class="contentOwner" x="10" y="15"><?php echo $content->getOwner()->handle; ?></text>
                </a>
                <text class="contentModified" x="10" y="27"><?php echo date('Y-m-d h:i:s', strtotime($content->modified)); ?></text>
                <?php $content->display(); ?>
                <a xlink:href="#">
                ...
                <?php if ($content->isPseudoRoot): ?>
                    <a xlink:href="#">
                        <text class="closeComments" x="10" y="115">&times;</text>
                    </a>
                <?php endif; ?>
            </g>
        </svg>
